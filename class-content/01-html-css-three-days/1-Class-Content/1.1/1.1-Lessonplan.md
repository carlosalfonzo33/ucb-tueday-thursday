## 1.1 Lesson Plan - The Zen of Coding
...
* Use the code in [`my-first-html.html`](Activities/3-MyFirstHTML/solution/my-first-html.html) as a guide. Be careful not to open the bonus file yet—that's for the next activity.
